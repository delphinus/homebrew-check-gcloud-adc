...
if args.contains("--help") || args.contains("-h") {
    ...
    print("profile, and the window is closed once gcloud exits. Set")
    print("CHECK_GCLOUD_ADC_BROWSER to another Chromium-based executable, or to an")
    print("empty string to fall back to the default browser.")
    print("CHECK_GCLOUD_ADC_BROWSER_PROFILE overrides where the profile lives.")
    print()
